...
def cleanup_old_release(context):
    ...
    jstool.unregisterResource('https://s7.addthis.com/js/250/addthis_widget.js#username=xa-4b7fc6a9319846fd')
    jstool.unregisterResource('https://s7.addthis.com/js/250/addthis_widget.js')
